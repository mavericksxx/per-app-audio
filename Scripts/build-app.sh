#!/bin/bash
# Builds the POC executable and assembles a signed .app bundle.
...
APP="$ROOT/build/PerAppVolumePOC.app"
...
cp "$BIN_DIR/PerAppVolumePOC" "$APP/Contents/MacOS/PerAppVolumePOC"
...
echo "(Do NOT run Contents/MacOS/PerAppVolumePOC directly - the tap will return silence.)"
